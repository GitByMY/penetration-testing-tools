...
```
git clone --recurse https://github.com/GitByMY/penetration-testing-tools.git
```

Most of these files were initially shared on my [Gists](https://gist.github.com/GitByMY) but eventually got moved into this repository.
...
[Consider buying me a coffee](https://github.com/sponsors/GitByMY) _(or better a beer)_ just to say thank you! 💪 
